...
public class AboutDlg /* extends JDialog */
{
    ...
    static public void showAboutDialog(Component component) {
        ...
        hep.setInnerHTMLById("apkscanner-title",
        ...
        boolean propNoLookPopup = "true".equals(
                PlugInConfig.getGlobalConfiguration(PlugInConfig.CONFIG_NO_LOOK_UPDATE_POPUP));
        ...
        MessageBoxPane.showMessageDialog(component, tabbedPanel, RStr.BTN_ABOUT.get(),
                MessageBoxPane.PLAIN_MESSAGE, null);
